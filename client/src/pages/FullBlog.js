...
const FullBlog = () => {
  ...
  const getBlogDetail = async () => {
    try {
      const { data } = await axios.get(`https://blogapp-9vhq.onrender.com/api/v1/blog/get-blog/${id}`);
      if (data?.success) {
  ...
  const getAllCmt = async () => {
    try {
      const { data } = await axios.get(`https://blogapp-9vhq.onrender.com/api/v1/cmt/comments/${id}`);
      // const { data } = await axios.get(`https://ooops-posted.onrender.comhttps://blogapp-9vhq.onrender.com/api/v1/cmt/comments/${id}`);
      if (data?.success) {
...
const finduser=async()=>{
  try {
    ...
    const data1 = await axios.get(`https://blogapp-9vhq.onrender.com/api/v1/user/singleuser/${userid}`);
    if(data1?.success){
  ...
  const addComment = async () => {
    try {
      ...
      setNm(data1?.data?.users?.username);
      console.log(nm);
      // const { data } = await axios.post("https://ooops-posted.onrender.comhttps://blogapp-9vhq.onrender.com/api/v1/cmt/comment/new", {
      const { data } = await axios.post("https://blogapp-9vhq.onrender.com/api/v1/cmt/comment/new", {
